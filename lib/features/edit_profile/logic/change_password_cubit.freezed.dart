...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ChangePasswordResponse changePasswordResponse)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.changePasswordResponse);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ChangePasswordResponse changePasswordResponse)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.changePasswordResponse);case Error():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ChangePasswordResponse changePasswordResponse)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements ChangePasswordState {
  const Loading();
...
class Success implements ChangePasswordState {
  const Success(this.changePasswordResponse);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.changePasswordResponse, changePasswordResponse) || other.changePasswordResponse == changePasswordResponse));
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ChangePasswordStateCopyWith<$Res> {
...
class Error implements ChangePasswordState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ChangePasswordStateCopyWith<$Res> {
