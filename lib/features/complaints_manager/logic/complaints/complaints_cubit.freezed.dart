...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ComplaintsResponse response)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ComplaintsResponse response)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ComplaintsResponse response)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class _Initial implements ComplaintsState {
  const _Initial();
...
class Loading implements ComplaintsState {
  const Loading();
...
class Success implements ComplaintsState {
  const Success(this.response);
  

 final  ComplaintsResponse response;
...
@override
String toString() {
  return 'ComplaintsState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ComplaintsStateCopyWith<$Res> {
...
class Error implements ComplaintsState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ComplaintsStateCopyWith<$Res> {
